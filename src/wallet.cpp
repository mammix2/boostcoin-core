...
// boostcoin: total coins staked (non-spendable until maturity)
...
// boostcoin: check 'spent' consistency between wallet and txindex
// boostcoin: fix wallet spent state according to txindex
...
// boostcoin: disable transaction (only for coinstake)
