...
void ThreadTopUpKeyPool(void* parg)
{
    ...
    RenameThread("boostcoin-key-top");
...
void ThreadCleanWalletPassphrase(void* parg)
{
    ...
    RenameThread("boostcoin-lock-wa");
...
Value walletpassphrase(const Array& params, bool fHelp)
{
    ...
    // boostcoin: if user OS account compromised prevent trivial sendmoney commands
    if (params.size() > 2)
...
// boostcoin: reserve balance from being staked for network protection
...
// boostcoin: check wallet integrity
...
// boostcoin: make a public-private key pair
